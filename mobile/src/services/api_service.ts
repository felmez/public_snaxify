...
export class APIService {
  ...
  constructor(private http: Http,
    ...
    // this.rootUrl = 'http://fulful.liliomlab.com/api/v1/';
    this.rootUrl = 'http://127.0.0.1:8000/api/v1/';
    // this.rootUrl = 'http://167.172.161.158/api/v1/';
    this.categories = [];
    this.restaurants = [];
    this.delivery_areas = [];
    this.token = null;
  ...
  createOrder(data): any {
    return this.http.post(`${this.rootUrl}order`, data).toPromise();
  }

...
class ResetContent extends Command
{
    ...
    {
        foreach (OrderedProduct::all() as $item) {
            $item->delete();
        }
        foreach (Order::all() as $item) {
            $item->delete();
        }
        foreach (DeliveryArea::all() as $item) {
            $item->delete();
        }
        foreach (PromoCode::all() as $item) {
            $item->delete();
        }
        ...
        foreach (NewsItem::all() as $item) {
            $item->delete();
        }
        foreach (\App\ApiToken::all() as $c) {
            $c->delete();
        }
